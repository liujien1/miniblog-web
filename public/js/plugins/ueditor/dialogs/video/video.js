...
(function(){
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            /** 插入上传文件到隐藏域 **/
            function addFileToDom(json){
                /*var object = {"original":'',"size":'',
                 "state":'',"title":'',"type":'',
                 "url":'',"sysfileid":''};*/
                var tempTag=document.createElement('input');
                tempTag.setAttribute("name",'sysfileid');
                tempTag.setAttribute("type",'hidden');
                tempTag.setAttribute("value",json.sysfileid);
                parent.document.getElementsByClassName("top-from")[0].appendChild(tempTag);
                return json;
            }
